...
VV.names <- read_xls('data/Survey2/Corona Citizens Science Project V0.4_April 23, 2020_04.28.xls', sheet='Data', col_names=FALSE, n_max=1) # Final Survey 2
VV.names['...17'][1] = 'Q5_1'
VV.names['...18'][1] = 'Q6_1'



VV <- read_csv('data/Survey2/Corona Citizens Science Project V0.4_April 23, 2020_04.28.csv', guess_max = 10000, skip=3, col_names=as.character(VV.names)) %>%
...
kable(table(VV$Q1),booktabs = TRUE) %>% kable_styling(latex_options = 'HOLD_position') # 52 refusals
...
kable(table(VV$Q66),booktabs = TRUE) %>% kable_styling(latex_options = 'HOLD_position') # 146 outside RoI
...
kable(table(VV$Q5))
kable(table(VV$Q5[VV$Age < 15])) # 45
```
...
Weights_Survey <- VV %>% select(ID, Q6, Age, Q5_1, Q7) %>%
...
save(VV,file = 'data/Survey2/Survey_2.rda')
write_csv(VV,'data/Survey_2.csv')
